      ...
      >
        <div className="flex items-start gap-3 pr-10">
          ...
          <div className="w-full">
            <div className="shrink-0 rounded-full bg-neutral-900 px-3 py-1 text-xs text-neutral-300 w-fit mb-2">
              {proposal.author}
            </div>
            <div className="flex items-start gap-2 w-full">
              <h3 className="font-medium leading-snug group-hover:text-neutral-50 transition-colors">
                {proposal.title}
              </h3>
              {/* open/closed pill */}
              <span
