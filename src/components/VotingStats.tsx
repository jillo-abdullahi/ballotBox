      ...
      <div className="mt-3 space-y-3">
          <div className="relative h-10 w-full rounded-xl bg-neutral-900 border-none overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-between px-3 text-sm font-medium">
              ...
              <span className="text-white">{yesVotes} ({yesPct}%)</span>
            </div>
          </div>

          <div className="relative h-10 w-full rounded-xl bg-neutral-900 border-none overflow-hidden">
            <div 
              className="h-full bg-red-text/90 transition-[width] duration-500" 
              style={{ width: `${noPct}%` }} 
            />
            <div className="absolute inset-0 flex items-center justify-between px-3 text-sm font-medium">
              <span className="text-white font-medium">No</span>
              <span className="text-white">{noVotes} ({noPct}%)</span>
            </div>
          </div>
